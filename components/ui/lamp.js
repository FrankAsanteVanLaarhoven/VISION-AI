  ...
  function LampDemo() {
    return React.createElement(
      ...
      React.createElement(
        ...
        ["Build lamps ", React.createElement("br", { key: "br" }), " the right way"]
      )
    );
  }
  
  const LampContainer = function({ children, className }) {
    return React.createElement(
      "div",
      {
        className: cn(
      ...
      [
        ...
        React.createElement(
          "div",
          { 
            className: "relative z-50 flex -translate-y-60 flex-col items-center px-5",
            key: "content"
          },
          children
        )
